...
public class GenerarDatos {
    ...
    public static List<Candidato> candidatos(){
        ...
        salida.add(new Candidato("Let�cia", "Dorado", 40213123, "05/03/1971", Cargo.DIPUTADO, new Domicilio("", "", "")));
        ...
        salida.add(new Candidato("Michael", "Ure�a", 41077481, "07/01/1973", Cargo.DIPUTADO, new Domicilio("", "", "")));
